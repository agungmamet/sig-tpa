              ...
              <div class="box-body">
                  ...
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Password</label>
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="inputPassword3" placeholder="Password" name="password" value="<?php echo $e->password?>" required>
                      </div>
                  </div>

                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Hak Akses</label>
                     &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="hakakses" value="1 <?php echo $e->hak_akses ?> "> Administrator
                     &nbsp;&nbsp;<input type="radio" name="hakakses" value="2 <?php echo $e->hak_akses ?> "> Manager
                     &nbsp;&nbsp;<input type="radio" name="hakakses" value="3 <?php echo $e->hak_akses ?> "> Client
                  </div>
