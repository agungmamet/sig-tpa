                    ...
                    <tbody>
                      ...
                      <tr>  
                          ...
                          <td style="text-align: center;">
                            <a href='<?php echo base_url();?>index.php/parameter/Lahan/editlahan/<?php echo $row->id_penggunaan_lahan?>' class='btn btn-success btn-sm'> 
                            <span class='fa fa-pencil'>Edit</a>
                            <a href='<?php echo base_url();?>index.php/parameter/Lahan/hapuslahan/<?php echo $row->id_penggunaan_lahan?>' class='btn btn-danger btn-sm' onClick="return doconfirm();">
