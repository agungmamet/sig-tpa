                    ...
                    <tbody>
                      ...
                      <tr>  
                          ...
                          <td style="text-align: center;">
                            <a href='<?php echo base_url();?>index.php/parameter/Longsor/editlongsor/<?php echo $row->id_rawan_longsor?>' class='btn btn-success btn-sm'> 
                            <span class='fa fa-pencil'>Edit</a>
                            <a href='<?php echo base_url();?>index.php/parameter/Longsor/hapuslongsor/<?php echo $row->id_rawan_longsor?>' class='btn btn-danger btn-sm' onClick="return doconfirm();">
