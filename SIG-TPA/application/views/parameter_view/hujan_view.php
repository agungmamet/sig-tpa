                    ...
                    <tbody>
                      ...
                      <tr>  
                          ...
                          <td style="text-align: center;">
                            <a href='<?php echo base_url();?>index.php/parameter/Hujan/edithujan/<?php echo $row->id_curah_hujan?>' class='btn btn-success btn-sm'> 
                            <span class='fa fa-pencil'>Edit</a>
                            <a href='<?php echo base_url();?>index.php/parameter/Hujan/hapushujan/<?php echo $row->id_curah_hujan?>' class='btn btn-danger btn-sm' onClick="return doconfirm();">
