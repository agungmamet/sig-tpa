                    ...
                    <tbody>
                      ...
                      <tr>  
                          ...
                          <td style="text-align: center;">
                            <a href='<?php echo base_url();?>index.php/parameter/Hidrogeologi/edithidro/<?php echo $row->id_hidrogeologi?>' class='btn btn-success btn-sm'> 
                            <span class='fa fa-pencil'>Edit</a>
                            <a href='<?php echo base_url();?>index.php/parameter/Hidrogeologi/hapushidro/<?php echo $row->id_hidrogeologi?>' class='btn btn-danger btn-sm' onClick="return doconfirm();">
