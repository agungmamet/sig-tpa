...
class Hujan_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_curah_hujan, nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_curah_hujan, bobot_parameter where daerah_tpa.id_daerah=data_curah_hujan.id_daerah and bobot_parameter.id_bobot=data_curah_hujan.id_bobot");
        return $data->result();
    }
