...
class Kelerengan_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_kelerengan, nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_kelerengan, bobot_parameter where daerah_tpa.id_daerah=data_kelerengan.id_daerah and bobot_parameter.id_bobot=data_kelerengan.id_bobot");
        return $data->result();
    }
