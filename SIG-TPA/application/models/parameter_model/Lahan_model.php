...
class Lahan_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_penggunaan_lahan, nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_penggunaan_lahan, bobot_parameter where daerah_tpa.id_daerah=data_penggunaan_lahan.id_daerah and bobot_parameter.id_bobot=data_penggunaan_lahan.id_bobot");
        return $data->result();
    }
