...
class Jenistanah_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_jenis_tanah, nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_jenis_tanah, bobot_parameter where daerah_tpa.id_daerah=data_jenis_tanah.id_daerah and bobot_parameter.id_bobot=data_jenis_tanah.id_bobot");
        return $data->result();
    }
