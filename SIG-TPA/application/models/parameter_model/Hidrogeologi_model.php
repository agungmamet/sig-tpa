...
class Hidrogeologi_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_hidrogeologi,nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_hidrogeologi, bobot_parameter where daerah_tpa.id_daerah=data_hidrogeologi.id_daerah and bobot_parameter.id_bobot=data_hidrogeologi.id_bobot");
        return $data->result();
    }
