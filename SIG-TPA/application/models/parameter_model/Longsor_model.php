...
class Longsor_model extends CI_Model {
    ...
    {
        $data=$this->db->query("SELECT id_rawan_longsor, nama_daerah, nilai_klasifikasi, keterangan, nilai_bobot from daerah_tpa, data_rawan_longsor, bobot_parameter where daerah_tpa.id_daerah=data_rawan_longsor.id_daerah and bobot_parameter.id_bobot=data_rawan_longsor.id_bobot");
        return $data->result();
    }
